let APP_ID = "35376878bca144c6952ffbe41112cb7e";
...
const captureImage = async () => {
  ...
  // Reverse the canvas context to create a mirror image
  context.save();
  ...
  // To send API to save capture image
  // try {
  ...
  }, 5000); // Hide canvas after 5 seconds
};
...
document.getElementById("picture-btn").addEventListener("click", captureImage);
